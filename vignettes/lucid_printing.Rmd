...
The `lucid` package provides functions for printing vectors and tables of
floating-point numbers in a human-friendly format.  An application is
presented for printing of variance components from mixed models.
...
\citep{ehrenberg1977rudiments, kozak2011reporting}, which considers the amount
...
\citep{pinheiro2014nlme} and `lme4` \citep{bates2014lme4} packages can be
