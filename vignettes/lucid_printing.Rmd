...
```
Extracting information from the sea of numbers above is difficult.  The `lucid` function comes to the resucue, simply by adding one more step to the sequence of pipes.
```{r, broom2}
